...
function MergeRouterPlugin() {
  // options是配置文件，你可以在这里进行一些与options相关的工作
}

MergeRouterPlugin.prototype.apply = function (compiler) {
...
function mergeConfig(config, dir, targetData) {
  const { view, models, extraModels, url, ...rest } = config;
...
module.exports = MergeRouterPlugin;
